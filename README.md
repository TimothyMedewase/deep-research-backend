...
[Link to app](https://deep-research-frontend-mu.vercel.app)
A FastAPI research agent that decomposes complex queries, uses tools to gather evidence, manages short-term and long-term memory under token and cost limits, and streams answers to the frontend over SSE.
...
Basically, the agent answers complex queries under memory and budget constraints, while workflow automation is used for routing and memory management.
